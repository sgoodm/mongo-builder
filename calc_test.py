...
# output file
in_out = "/var/www/html/aiddata/data/form/form_data_test.json"

# read in builder_data.json
builder_data_handle = open('/var/www/html/aiddata/data/form/builder_data_test.json', 'r')
...
with open('/var/www/html/aiddata/data/form/builder_data_test.json', 'w') as temp_handle:

	# dump json back into builder_data.json with new thresh values
